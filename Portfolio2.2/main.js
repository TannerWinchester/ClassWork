...
2/23 - Added filter for the examples page. || 
2/24 - Made modifications to contact form  || added AOS animations || added in the contact form validation, needs some improvement..||
